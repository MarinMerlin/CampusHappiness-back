const mail = function (user) {
  return `<br /><br />
    ...
    <![endif]--><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1"><title></title><style type="text/css">p{
        margin:10px 0;
        padding:0;
    }
    table{
  ...
  @media only screen and (min-width:768px){
    ...
    #templateFooter .mcnTextContent,#templateFooter .mcnTextContent p{
        ...
        line-height:150% !important;
            ...
            If you want to change them click on the <a href="http://localhost:3000/login">
            link
            </a> and login with your default credentials.</p>
            <p style="margin: 10px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">&nbsp;</p></td></tr></tbody></table><!--[if mso]>
            </td>
            <![endif]--><!--[if mso]>
            </tr>
            </table>
  ...
  --></td></tr></tbody></table><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;"><tbody class="mcnTextBlockOuter"><tr><td valign="top" class="mcnTextBlockInner" style="padding-top: 9px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;"><!--[if mso]>
            ...
            <![endif]--></td></tr></tbody></table></td></tr></tbody></table><!--[if (gte mso 9)|(IE)]>
                    ...
                    <![endif]--><!-- // END TEMPLATE --></td></tr></tbody></table></center><br /><br /><br />&nbsp;`;
}; 
